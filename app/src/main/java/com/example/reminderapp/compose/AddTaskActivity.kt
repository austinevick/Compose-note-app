...
import com.example.reminderapp.AlarmReceiver
import com.example.reminderapp.components.CustomDropdown
import com.example.reminderapp.components.CustomTextField
...
class AddTaskActivity() : Screen {
    ...
    override fun Content() {
        ...
        val simpleFormatter: String =
            SimpleDateFormat.getDateTimeInstance().format(Date(startAtMillis))
            ...
            Column(
                ...
                Button(colors = ButtonDefaults.buttonColors(
                    ...
                    onClick = {
                        ...
                        Log.d("ase", "${hours.value} ${minutes.value}")
                        if (setReminder.value) alarmManager.setAlarmClock(
